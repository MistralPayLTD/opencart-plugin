...
class RoboFile extends \Robo\Tasks
{
    ...
    public function build()
    {
        ...
        $this->taskFileSystemStack()->mirror('src', 'build/mistralpay-opencart')->run();
        $this->taskExec('zip')->dir('build/mistralpay-opencart')->arg('-r')->arg('../mistralpay-openchart.ocmod.zip')->arg('./')->run();
    }
}
